...
ВАЖЛИВО — правила визначення наміру:
- Якщо повідомлення описує ДІЮ яку треба зробити (купити, зателефонувати, зустріч, зробити, оплатити, тощо) — це ЗАВЖДИ intent "create", навіть якщо дата/час не вказані
...
- intent "chat" — ТІЛЬКИ для привітань, запитань, розмов, НЕ для задач
...
- "в суботу" = найближча субота
- "на вихідних" = найближча субота 10:00""",
